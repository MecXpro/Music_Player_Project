...
class Player(tk.Frame):
    ...
    def retrieve_songs(self):
        conn = psycopg2.connect(
            ...
            password="rohan@3381",                                                                                                          # Replace with your PostgreSQL password
        ...
        cur.execute("SELECT file_path FROM music WHERE user_id IN (%s)",(user_id))
        ...
        cur.close()
        conn.close()
        self.songlist = self.playlist = [row[0] for row in rows]
...
root.wm_title('Musicxy')
                                                                                                                                               ...
                                                                                                                                               # Load images
img = PhotoImage(file='/home/rohan/Desktop/Music Player/images/music.gif')
next_ = PhotoImage(file='/home/rohan/Desktop/Music Player/images/next.gif')
prev = PhotoImage(file='/home/rohan/Desktop/Music Player/images/previous.gif')
play = PhotoImage(file='/home/rohan/Desktop/Music Player/images/play.gif')
pause = PhotoImage(file='/home/rohan/Desktop/Music Player/images/pause.gif')
